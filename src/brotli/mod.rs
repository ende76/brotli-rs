...
mod lookuptable;
use ::brotli::lookuptable::{ LUT_0, LUT_1, LUT_2 };
	...
	fn copy_literals(&mut self) -> Result<State, DecompressorError> {
		...
		if distance <=  max_allowed_distance {
			...
			let transformed_word = match transform_id {
				  ...
				  4 => [Self::uppercase_first(base_word), vec![0x20]].concat(),
				  ...
				  9 => Self::uppercase_first(base_word),
				 ...
				 15 => [vec![0x20], Self::uppercase_first(base_word), vec![0x20]].concat(),
				 ...
				 30 => [vec![0x20], Self::uppercase_first(base_word)].concat(),
				 ...
				 44 => Self::uppercase_all(base_word),
				 ...
				 58 => [Self::uppercase_first(base_word), vec![0x2c, 0x20]].concat(),
				 ...
				 65 => [vec![0x20], Self::uppercase_first(base_word), vec![0x2c, 0x20]].concat(),
				 66 => [Self::uppercase_first(base_word), vec![0x22]].concat(),
				 67 => [vec![0x2e], Vec::from(base_word), vec![0x28]].concat(),
				 68 => [Self::uppercase_all(base_word), vec![0x20]].concat(),
				 69 => [Self::uppercase_first(base_word), vec![0x22, 0x3e]].concat(),
				 ...
				 74 => [Self::uppercase_first(base_word), vec![0x27]].concat(),
				 ...
				 78 => [Self::uppercase_first(base_word), vec![0x28]].concat(),
				 79 => [Self::uppercase_first(base_word), vec![0x2e]].concat(),
				 ...
				 83 => [vec![0x20], Self::uppercase_all(base_word), vec![0x20]].concat(),
				 84 => [Vec::from(base_word), vec![0x61, 0x6c, 0x20]].concat(),
				 85 => [vec![0x20], Self::uppercase_all(base_word)].concat(),
				 86 => [Vec::from(base_word), vec![0x3d, 0x27]].concat(),
				 87 => [Self::uppercase_all(base_word), vec![0x22]].concat(),
				 88 => [Self::uppercase_first(base_word), vec![0x2e, 0x20]].concat(),
				 89 => [vec![0x20], Vec::from(base_word), vec![0x28]].concat(),
				 90 => [Vec::from(base_word), vec![0x66, 0x75, 0x6c, 0x20]].concat(),
				 91 => [vec![0x20], Self::uppercase_first(base_word), vec![0x2e, 0x20]].concat(),
				 92 => [Vec::from(base_word), vec![0x69, 0x76, 0x65, 0x20]].concat(),
				 93 => [Vec::from(base_word), vec![0x6c, 0x65, 0x73, 0x73, 0x20]].concat(),
				 94 => [Self::uppercase_all(base_word), vec![0x27]].concat(),
				 95 => [Vec::from(base_word), vec![0x65, 0x73, 0x74, 0x20]].concat(),
				 96 => [vec![0x20], Self::uppercase_first(base_word), vec![0x2e]].concat(),
				 97 => [Self::uppercase_all(base_word), vec![0x22, 0x3e]].concat(),
				 98 => [vec![0x20], Vec::from(base_word), vec![0x3d, 0x27]].concat(),
				 99 => [Self::uppercase_first(base_word), vec![0x2c]].concat(),
				100 => [Vec::from(base_word), vec![0x69, 0x7a, 0x65, 0x20]].concat(),
				101 => [Self::uppercase_all(base_word), vec![0x2e]].concat(),
				102 => [vec![0xc2, 0xa0], Vec::from(base_word)].concat(),
				103 => [vec![0x20], Vec::from(base_word), vec![0x2c]].concat(),
				104 => [Self::uppercase_first(base_word), vec![0x3d, 0x22]].concat(),
				105 => [Self::uppercase_all(base_word), vec![0x3d, 0x22]].concat(),
				106 => [Vec::from(base_word), vec![0x6f, 0x75, 0x73, 0x20]].concat(),
				107 => [Self::uppercase_all(base_word), vec![0x2c, 0x20]].concat(),
				108 => [Self::uppercase_first(base_word), vec![0x3d, 0x27]].concat(),
				109 => [vec![0x20], Self::uppercase_first(base_word), vec![0x2c]].concat(),
				110 => [vec![0x20], Self::uppercase_all(base_word), vec![0x3d, 0x22]].concat(),
				111 => [vec![0x20], Self::uppercase_all(base_word), vec![0x2c, 0x20]].concat(),
				112 => [Self::uppercase_all(base_word), vec![0x2c]].concat(),
				113 => [Self::uppercase_all(base_word), vec![0x28]].concat(),
				114 => [Self::uppercase_all(base_word), vec![0x2e, 0x20]].concat(),
				115 => [vec![0x20], Self::uppercase_all(base_word), vec![0x2e]].concat(),
				116 => [Self::uppercase_all(base_word), vec![0x3d, 0x27]].concat(),
				117 => [vec![0x20], Self::uppercase_all(base_word), vec![0x2e, 0x20]].concat(),
				118 => [vec![0x20], Self::uppercase_first(base_word), vec![0x3d, 0x22]].concat(),
				119 => [vec![0x20], Self::uppercase_all(base_word), vec![0x3d, 0x27]].concat(),
				120 => [vec![0x20], Self::uppercase_first(base_word), vec![0x3d, 0x27]].concat(),
				_ => unreachable!(),
			};
