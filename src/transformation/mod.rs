...
pub fn transformation(id: usize, base_word: &[u8]) -> Vec<u8> {
    match id {
        ...
        49 => {
            [Vec::from(&base_word[..max(1, base_word.len()) - 1]), vec![0x69, 0x6e, 0x67, 0x20]]
                .concat()
        }
        ...
        62 => {
            [vec![0x20, 0x74, 0x68, 0x65, 0x20], Vec::from(base_word), vec![0x20, 0x6f, 0x66, 0x20]]
                .concat()
        }
        ...
        73 => {
            [vec![0x20, 0x74, 0x68, 0x65, 0x20],
             Vec::from(base_word),
             vec![0x20, 0x6f, 0x66, 0x20, 0x74, 0x68, 0x65, 0x20]]
                .concat()
        }
...
mod tests {
    ...
    fn should_transform_0() {
        ...
        assert_eq!(String::from_utf8(transformation(0, &base_word)).unwrap(),
    ...
    fn should_transform_1() {
        ...
        assert_eq!(String::from_utf8(transformation(1, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_2() {
        ...
        assert_eq!(String::from_utf8(transformation(2, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_3() {
        ...
        assert_eq!(String::from_utf8(transformation(3, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_4() {
        ...
        assert_eq!(String::from_utf8(transformation(4, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_5() {
        ...
        assert_eq!(String::from_utf8(transformation(5, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_6() {
        ...
        assert_eq!(String::from_utf8(transformation(6, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_7() {
        ...
        assert_eq!(String::from_utf8(transformation(7, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_8() {
        ...
        assert_eq!(String::from_utf8(transformation(8, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_9() {
        ...
        assert_eq!(String::from_utf8(transformation(9, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_10() {
        ...
        assert_eq!(String::from_utf8(transformation(10, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_11() {
        ...
        assert_eq!(String::from_utf8(transformation(11, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_12() {
        ...
        assert_eq!(String::from_utf8(transformation(12, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_13() {
        ...
        assert_eq!(String::from_utf8(transformation(13, &base_word)).unwrap(),
                   String::from(expected));
    }
    #[test]
    fn should_transform_14() {
        ...
        assert_eq!(String::from_utf8(transformation(14, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_15() {
        ...
        assert_eq!(String::from_utf8(transformation(15, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_16() {
        ...
        assert_eq!(String::from_utf8(transformation(16, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_17() {
        ...
        assert_eq!(String::from_utf8(transformation(17, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_18() {
        ...
        assert_eq!(String::from_utf8(transformation(18, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_19() {
        ...
        assert_eq!(String::from_utf8(transformation(19, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_20() {
        ...
        assert_eq!(String::from_utf8(transformation(20, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_21() {
        ...
        assert_eq!(String::from_utf8(transformation(21, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_22() {
        ...
        assert_eq!(String::from_utf8(transformation(22, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_23() {
        ...
        assert_eq!(String::from_utf8(transformation(23, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_24() {
        ...
        assert_eq!(String::from_utf8(transformation(24, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_25() {
        ...
        assert_eq!(String::from_utf8(transformation(25, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_26() {
        ...
        assert_eq!(String::from_utf8(transformation(26, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_27() {
        ...
        assert_eq!(String::from_utf8(transformation(27, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_28() {
        ...
        assert_eq!(String::from_utf8(transformation(28, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_29() {
        ...
        assert_eq!(String::from_utf8(transformation(29, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_30() {
        ...
        assert_eq!(String::from_utf8(transformation(30, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_31() {
        ...
        assert_eq!(String::from_utf8(transformation(31, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_32() {
        ...
        assert_eq!(String::from_utf8(transformation(32, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_33() {
        ...
        assert_eq!(String::from_utf8(transformation(33, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_34() {
        ...
        assert_eq!(String::from_utf8(transformation(34, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_35() {
        ...
        assert_eq!(String::from_utf8(transformation(35, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_36() {
        ...
        assert_eq!(String::from_utf8(transformation(36, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_37() {
        ...
        assert_eq!(String::from_utf8(transformation(37, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_38() {
        ...
        assert_eq!(String::from_utf8(transformation(38, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_39() {
        ...
        assert_eq!(String::from_utf8(transformation(39, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_40() {
        ...
        assert_eq!(String::from_utf8(transformation(40, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_41() {
        ...
        assert_eq!(String::from_utf8(transformation(41, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_42() {
        ...
        assert_eq!(String::from_utf8(transformation(42, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_43() {
        ...
        assert_eq!(String::from_utf8(transformation(43, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_44() {
        ...
        assert_eq!(String::from_utf8(transformation(44, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_45() {
        ...
        assert_eq!(String::from_utf8(transformation(45, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_46() {
        ...
        assert_eq!(String::from_utf8(transformation(46, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_47() {
        ...
        assert_eq!(String::from_utf8(transformation(47, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_48() {
        ...
        assert_eq!(String::from_utf8(transformation(48, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_49() {
        ...
        assert_eq!(String::from_utf8(transformation(49, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_50() {
        ...
        assert_eq!(String::from_utf8(transformation(50, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_51() {
        ...
        assert_eq!(String::from_utf8(transformation(51, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_52() {
        ...
        assert_eq!(String::from_utf8(transformation(52, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_53() {
        ...
        assert_eq!(String::from_utf8(transformation(53, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_54() {
        ...
        assert_eq!(String::from_utf8(transformation(54, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_55() {
        ...
        assert_eq!(String::from_utf8(transformation(55, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_56() {
        ...
        assert_eq!(String::from_utf8(transformation(56, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_57() {
        ...
        assert_eq!(String::from_utf8(transformation(57, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_58() {
        ...
        assert_eq!(String::from_utf8(transformation(58, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_59() {
        ...
        assert_eq!(String::from_utf8(transformation(59, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_60() {
        ...
        assert_eq!(String::from_utf8(transformation(60, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_61() {
        ...
        assert_eq!(String::from_utf8(transformation(61, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_62() {
        ...
        assert_eq!(String::from_utf8(transformation(62, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_63() {
        ...
        assert_eq!(String::from_utf8(transformation(63, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_64() {
        ...
        assert_eq!(String::from_utf8(transformation(64, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_65() {
        ...
        assert_eq!(String::from_utf8(transformation(65, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_66() {
        ...
        assert_eq!(String::from_utf8(transformation(66, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_67() {
        ...
        assert_eq!(String::from_utf8(transformation(67, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_68() {
        ...
        assert_eq!(String::from_utf8(transformation(68, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_69() {
        ...
        assert_eq!(String::from_utf8(transformation(69, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_70() {
        ...
        assert_eq!(String::from_utf8(transformation(70, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_71() {
        ...
        assert_eq!(String::from_utf8(transformation(71, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_72() {
        ...
        assert_eq!(String::from_utf8(transformation(72, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_73() {
        ...
        assert_eq!(String::from_utf8(transformation(73, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_74() {
        ...
        assert_eq!(String::from_utf8(transformation(74, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_75() {
        ...
        assert_eq!(String::from_utf8(transformation(75, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_76() {
        ...
        assert_eq!(String::from_utf8(transformation(76, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_77() {
        ...
        assert_eq!(String::from_utf8(transformation(77, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_78() {
        ...
        assert_eq!(String::from_utf8(transformation(78, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_79() {
        ...
        assert_eq!(String::from_utf8(transformation(79, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_80() {
        ...
        assert_eq!(String::from_utf8(transformation(80, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_81() {
        ...
        assert_eq!(String::from_utf8(transformation(81, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_82() {
        ...
        assert_eq!(String::from_utf8(transformation(82, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_83() {
        ...
        assert_eq!(String::from_utf8(transformation(83, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_84() {
        ...
        assert_eq!(String::from_utf8(transformation(84, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_85() {
        ...
        assert_eq!(String::from_utf8(transformation(85, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_86() {
        ...
        assert_eq!(String::from_utf8(transformation(86, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_87() {
        ...
        assert_eq!(String::from_utf8(transformation(87, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_88() {
        ...
        assert_eq!(String::from_utf8(transformation(88, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_89() {
        ...
        assert_eq!(String::from_utf8(transformation(89, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_90() {
        ...
        assert_eq!(String::from_utf8(transformation(90, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_91() {
        ...
        assert_eq!(String::from_utf8(transformation(91, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_92() {
        ...
        assert_eq!(String::from_utf8(transformation(92, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_93() {
        ...
        assert_eq!(String::from_utf8(transformation(93, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_94() {
        ...
        assert_eq!(String::from_utf8(transformation(94, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_95() {
        ...
        assert_eq!(String::from_utf8(transformation(95, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_96() {
        ...
        assert_eq!(String::from_utf8(transformation(96, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_97() {
        ...
        assert_eq!(String::from_utf8(transformation(97, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_98() {
        ...
        assert_eq!(String::from_utf8(transformation(98, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_99() {
        ...
        assert_eq!(String::from_utf8(transformation(99, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_100() {
        ...
        assert_eq!(String::from_utf8(transformation(100, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_101() {
        ...
        assert_eq!(String::from_utf8(transformation(101, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_103() {
        ...
        assert_eq!(String::from_utf8(transformation(103, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_104() {
        ...
        assert_eq!(String::from_utf8(transformation(104, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_105() {
        ...
        assert_eq!(String::from_utf8(transformation(105, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_106() {
        ...
        assert_eq!(String::from_utf8(transformation(106, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_107() {
        ...
        assert_eq!(String::from_utf8(transformation(107, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_108() {
        ...
        assert_eq!(String::from_utf8(transformation(108, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_109() {
        ...
        assert_eq!(String::from_utf8(transformation(109, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_110() {
        ...
        assert_eq!(String::from_utf8(transformation(110, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_111() {
        ...
        assert_eq!(String::from_utf8(transformation(111, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_112() {
        ...
        assert_eq!(String::from_utf8(transformation(112, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_113() {
        ...
        assert_eq!(String::from_utf8(transformation(113, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_114() {
        ...
        assert_eq!(String::from_utf8(transformation(114, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_115() {
        ...
        assert_eq!(String::from_utf8(transformation(115, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_116() {
        ...
        assert_eq!(String::from_utf8(transformation(116, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_117() {
        ...
        assert_eq!(String::from_utf8(transformation(117, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_118() {
        ...
        assert_eq!(String::from_utf8(transformation(118, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_119() {
        ...
        assert_eq!(String::from_utf8(transformation(119, &base_word)).unwrap(),
                   String::from(expected));
    }
    ...
    fn should_transform_120() {
        ...
        assert_eq!(String::from_utf8(transformation(120, &base_word)).unwrap(),
                   String::from(expected));
    }
}
